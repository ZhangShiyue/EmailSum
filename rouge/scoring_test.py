...
"""Tests for myrouge scoring and aggregation.
...
# Delta for matching against ground truth myrouge values. Must be relatively
# high compared to the individual myrouge tests since bootstrap sampling
